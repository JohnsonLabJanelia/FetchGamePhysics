...
namespace RosMessageTypes.UrMoveit
{
    ...
    {
        public const string k_RosMessageName = "ur_moveit/MoverService";
        public override string RosMessageName => k_RosMessageName;

        public UR10MoveitJointsMsg joints_input;
        public Geometry.PoseMsg pick_pose;
        public Geometry.PoseMsg place_pose;

        public MoverServiceRequest()
        {
            this.joints_input = new UR10MoveitJointsMsg();
            this.pick_pose = new Geometry.PoseMsg();
            this.place_pose = new Geometry.PoseMsg();
        }

        public MoverServiceRequest(UR10MoveitJointsMsg joints_input, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
        ...
        {
            this.joints_input = UR10MoveitJointsMsg.Deserialize(deserializer);
